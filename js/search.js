...
var formSearchElm = document.querySelectorAll('.header-search');
var searchInputElm = document.querySelectorAll('.search');

for (let index = 0; index < formSearchElm.length; index++) {
    formSearchElm[index].addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        ref.get().then(async function(snapshots) {
            ...
            let valueSearch = searchInputElm[index].value.trim().toLowerCase();
